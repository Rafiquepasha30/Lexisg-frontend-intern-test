        ...
        citations: [
          {
            ...
            link:
              "https://lexisingapore-my.sharepoint.com/:b:/g/personal/harshit_lexi_sg/EdOegeiR_gdBvQxdyW4xE6oBCDgj5E4Bo5wjvhPHpqgIuQ?e=TEu4vz#para7"
          }
        ]
      };
  ...
  return (
    <div className="app-container">
      <div className="app-card">
        <h1 className="app-title">Lexi Legal Assistant</h1>
        <InputPanel
          query={query}
          setQuery={setQuery}
          loading={loading}
